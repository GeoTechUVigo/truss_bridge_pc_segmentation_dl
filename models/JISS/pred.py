...
parser.add_argument('--model_path', default='data_/trained_models/k_0/epoch_0636.ckpt', help='Log dir [default: ]')
parser.add_argument('--path_pred', type=str, default='data_/pred', help='Folder to save predicted point clouds [default: data/pred]')
